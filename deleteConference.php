        	...
        	<div class="col-lg-6 col-xs-offset-3 main">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                  	<h3 class="text-center">Delete Conference</h3>
                  </div>
                  ...
                  <div class="panel-body">
                    ...
                    <div class="col-lg-12 space">
                    	<form method="get" action="conference.php">
                            <input type="hidden" name="pageType" value="deleteConference.php">
                    ...
                    <div class="col-lg-12 space">
                        <div class="col-lg-9 col-xs-offset-3">
							<input type="submit" value="Delete Conference" id="update1" class="form-control btn btn-danger" disabled> 
                        </div>
                    </div>
                    </form>                   
                 </div>
