...
<html>
	...
	<body>
        ...
        <form method="POST" action="users.php">
            <input type="hidden" name="pageType" value="forgot.php">
        	<div class="col-lg-6 col-xs-offset-3 main">
            	
                <div class="panel panel-default">
                  <div class="panel-heading">
                  	<h3 class="text-center"><a href="sessionLogin.php"> Login</a> | <a href="./SignUp.php">SignUp</a></h3>
                  </div>
                  ...
                  <div class="panel-body">
                    ...
                    <div id="error" hidden style="margin-left: 180px;margin-top: 50px;position: absolute;"><font color=red><b>login email does not exists</b></font></div>
                    <?php 
                        //$error=2;
                    ...
                    <div class="col-lg-12 space">
                        <div class="col-lg-3 col-xs-offset-9 pull-right">
							<input type="submit" value="Reset" class="form-control btn btn-success" ><br/><br/>
